...
import (
	...
	"github.com/puhproject/puhoin/ethstats"
	"github.com/puhproject/puhoin/les"
	"github.com/puhproject/puhoin/log"
	"github.com/puhproject/puhoin/node"
	"github.com/puhproject/puhoin/p2p"
	"github.com/puhproject/puhoin/p2p/discv5"
	"github.com/puhproject/puhoin/p2p/enode"
	"github.com/puhproject/puhoin/p2p/nat"
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/puhproject/puhoin/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
